    ...
    class NumberAsWords
    {
        ...
        static void Main()
        {
            ...
            while (true)
            {
                ...
                string[] fromElevenToNineteen = { "eleven", "twelve", "thirteen", "fourteen","fifteen", "sixteen", "seventeen", "eighteen", "nineteen" };
                ...
                else
                {
                    ...
                    int fromEtoNCalc = tensCalc1 - 10;
                    int numsCalc = (input % 100) % 10;
                    if (tensCalc1 > 10 && tensCalc1 < 20)
                    {
                        Console.WriteLine(hundreds[hundredsCalc - 1] + " and " + fromElevenToNineteen[fromEtoNCalc - 1]);
                    }
                    else if (numsCalc == 0)
                    {
