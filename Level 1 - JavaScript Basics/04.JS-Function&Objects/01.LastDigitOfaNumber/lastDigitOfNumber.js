// Write a JavaScript function lastDigitAsText(number) that returns the last digit of given
// integer as an English word. Write a JS program lastDigitOfNumber.js that invokes your function with the
